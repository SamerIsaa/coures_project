        ...
        <div class="modal-content">
            <div class="flat-account">
                <div class="banner-account">
                    <img src="{{ asset('frontAssets/images/banner/banner-account1.jpg') }}" alt="banner">
                </div>
                <form class="form-account">
                    ...
                    <div class="group-btn">
                        <a href="#" class="btn-social">
                            <img src="{{ asset('frontAssets/images/logo/google.jpg') }}" alt="img">
                            Google
                        </a>
                        <a href="#" class="btn-social">
                            <img src="{{ asset('frontAssets/images/logo/fb.jpg') }}" alt="img">
                            Facebook
                        </a>
...
<div class="modal modal-account fade" id="modalRegister">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="flat-account">
                <div class="banner-account">
                    <img src="{{ asset('frontAssets/images/banner/banner-account2.jpg') }}" alt="banner">
                </div>
                <form class="form-account">
                    <div class="title-box">
                        <h4>Register</h4>
