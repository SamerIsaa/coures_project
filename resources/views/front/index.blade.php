@extends('front.layout.master' , ['title' => __('panel.home')])
...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="slider-content">
                        <div class="heading text-center">
                            ...
                            <p class="subtitle text-white body-2 wow fadeInUp" data-wow-delay=".2s">We are a real estate
                                agency that will help you find the best residence you dream of, let’s discuss for your
                                dream house?</p>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="flat-tab-recommended flat-animate-tab wow fadeInUp" data-wow-delay=".2s">
                <ul class="nav-tab-recommended justify-content-md-center" role="tablist">
                    ...
                    <li class="nav-tab-item" role="presentation">
                        <a href="#php" class="nav-link-item  active" data-bs-toggle="tab">Php</a>
                    </li>
                    <li class="nav-tab-item" role="presentation">
                        <a href="#Flutter" class="nav-link-item" data-bs-toggle="tab">Flutter</a>
                    </li>
                    <li class="nav-tab-item" role="presentation">
                        <a href="#Games" class="nav-link-item" data-bs-toggle="tab">Games</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane" id="viewAll" role="tabpanel">
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                @include('front.components.courses.card')
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                @include('front.components.courses.card')
                            </div>
                        ...
                        <div class="text-center">
                            <a href="/" class="tf-btn btn-view primary size-1 hover-btn-view">View All<span
                                    class="icon icon-arrow-right2"></span></a>
                        </div>
                    </div>
                    <div class="tab-pane active show" id="php" role="tabpanel">
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                @include('front.components.courses.card')
                            </div>
                    ...
                    <div class="tab-pane" id="Flutter" role="tabpanel">
                        <div class="row">
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                @include('front.components.courses.card')
                            </div>
        ...
        <div class="container">
            ...
            <div dir="ltr" class="wow fadeInUp swiper tf-sw-mobile" data-wow-delay=".2s" data-screen="767"
                ...
                <div class="text-center sec-btn">
                    <a href="/" class="tf-btn btn-view primary size-1 hover-btn-view">View All<span class="icon icon-arrow-right2"></span></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="flat-section bg-primary-new flat-testimonial">
        <div class="box-title px-15 wow fadeInUp">
            <div class="text-center wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="2000ms">
                ...
                <p class="desc text-variant-1">Our seasoned team excels in real estate with years of successful market
                    navigation, offering informed decisions and optimal results.</p>
            </div>
        </div>
        <div dir="ltr" class="swiper tf-sw-testimonial wow fadeInUp" data-wow-delay=".2s" data-preview="4.5"
             data-tablet="2" data-mobile-sm="1" data-mobile="1" data-space="15" data-space-md="30" data-space-lg="30"
        ...
        <div class="container">
            ...
            <div dir="ltr" class="swiper tf-sw-mobile-1" data-screen="575" data-preview="1" data-space="15">
                <div class="tf-layout-mobile-sm xl-col-4 sm-col-2 swiper-wrapper">
                    <div class="swiper-slide">
                        @include('front.components.agent_card')
                    </div>
                    <div class="swiper-slide">
                       @include('front.components.agent_card')
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="partner-item">
                            <svg width="160" height="80" viewBox="0 0 160 80" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <rect width="160" height="80" fill="white"/>
                                <path d="M65.9719 53.383L64.1897 50.3278L50.3565 26.353H46.877L62.45 53.383H65.9719Z"
                                      fill="#B9B9B9"/>
                                <path
                                ...
                                <path
                                    ...
                                    fill="#B9B9B9"/>
                                <path d="M92.7046 7.0459H89.1826L76.4526 29.1536L78.1924 32.1664L92.7046 7.0459Z"
                                      fill="#B9B9B9"/>
                                <path
                                ...
                                <path
                                    ...
                                    fill="#B9B9B9"/>
                                <path d="M113.666 7.0459H110.144L86.9332 47.2726V47.3151L88.673 50.3278L113.666 7.0459Z"
                                      fill="#B9B9B9"/>
                                <path
                                ...
                                <path
                                    ...
                                    fill="#B9B9B9"/>
                                <path d="M44.5 70.9932H45.2638V73.3695H45.6881V70.9932H46.4519V70.6113H44.5V70.9932Z"
                                      fill="#B9B9B9"/>
                                <path
                        ...
                        <div class="partner-item">
                            <svg width="160" height="80" viewBox="0 0 160 80" fill="none"
                                ...
                                <g clip-path="url(#clip0_13428_2256)">
                                    <mask id="mask0_13428_2256" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                          x="-16" y="-56" width="194" height="193">
                        ...
                        <div class="partner-item">
                            <svg width="160" height="80" viewBox="0 0 160 80" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#BBBBBB"/>
                                <path d="M136.203 38.9473V41.4321H137.658V31.7002H136.273V39.0163L136.203 38.9473Z"
                                      fill="#BBBBBB"/>
    ...
    <section class="flat-section bg-primary-new">
        <div class="container">
            ...
            <div dir="ltr" class="swiper tf-sw-latest wow fadeInUp" data-wow-delay=".2s" data-preview="3"
                 data-tablet="2" data-mobile-sm="2" data-mobile="1" data-space-lg="30" data-space-md="15"
                 data-space="15">
                <div class="swiper-wrapper">
                    @foreach($blogs as $blog)
                        <div class="swiper-slide">
                            @include('front.components.blog_card')
                        </div>
                    @endforeach
                </div>
